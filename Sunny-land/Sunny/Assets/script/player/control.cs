...
public class control : MonoBehaviour { 
   ...
   public void crouch()
    ...
    public  void Jump()
    {
        ...
        if (Physics2D.Raycast(begin, direction, 1.1f, Ground))
        {
            if (/*Input.GetButtonDown("Jump") &&*/ rb.IsTouchingLayers(Ground) && anim.GetBool("IScrouch") == false)//趴下不能跳   //手机注释
            {
    ...
    public void Fire()
    {
        if (/*Input.GetButtonDown("Fire1") && */Time.timeScale == 1)//手机注释
        {
